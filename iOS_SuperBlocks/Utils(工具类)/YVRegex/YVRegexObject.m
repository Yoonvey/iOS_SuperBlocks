...
//  YVOpenSourceLibrary
//
//  Created by Yoonvey on 2019/6/1.
//  Copyright © 2019 Yoonvey. All rights reserved.
//

#import "YVRegexObject.h"

@implementation YVRegexObject
...
{
    NSString *regex = [NSString stringWithFormat:@"^\\d{%ld,%ld}$",(long)fromFigure,toFigure];
    return [self regexPatternResultWithRegex:regex TargetString:targetString];
}
